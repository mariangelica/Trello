...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { description: @homework.description, duration: @homework.duration, enddate: @homework.enddate, finished: @homework.finished, startdate: @homework.startdate, team_id: @homework.team_id, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { description: @homework.description, duration: @homework.duration, enddate: @homework.enddate, finished: @homework.finished, startdate: @homework.startdate, team_id: @homework.team_id, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
